...
public class SwerveWithHighCube extends InstantCommand {
  ...
  public SwerveWithHighCube(DriveSubsystem m_robotDrive, WristSubsystem m_WristSubsystem, WristIntake m_WristIntake, ArmSubsystem m_ArmSubsystem) {
